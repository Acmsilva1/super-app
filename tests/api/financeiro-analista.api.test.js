...
describe('API do financeiro analista', () => {
  ...
  it('gera analise e persiste estado adaptativo', async () => {
    const rowsFinancas = [
      { id: 10, tipo: 'receita', valor: 2500, created_at: '2026-01-03T10:00:00.000Z', categoria: 'Salario' },
      { id: 18, tipo: 'despesa', valor: 300, created_at: '2026-01-10T10:00:00.000Z', categoria: 'Transporte' },
    ...
    const rowsFixas = [
      { id: 20, valor: 900, created_at: '2026-01-05T10:00:00.000Z' },
